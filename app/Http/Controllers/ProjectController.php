...
class ProjectController extends Controller
{
    ...
    public function update(Request $request, Project $project)
    {
        ...
        return redirect()->route('projects.index')->with('success', 'Cập nhật dự án thành công.');
    }
    ...
    public function destroy(Project $project)
    {
        ...
        return redirect()->route('projects.index')->with('success', 'Xóa dự án thành công.');
    }
    ...
    public function addMember(Request $request)
    {
        ...
        return redirect()->back()->with('success', 'Thêm người vào dự án thành công.');
    }
}
